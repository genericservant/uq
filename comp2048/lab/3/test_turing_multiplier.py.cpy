...
multiplier = TuringMachine(
    ...
    ('qDoaddr', '1'): ('qDoaddr1', 'X', 'L'),
    ('qDoaddr1', '1'): ('qDoaddr1', '1', 'L'),
    ('qDoaddr1', 'D'): ('qDoaddr2', '1', 'L'),
    ('qDoaddr2', '1'): ('qDoaddr2', '1', 'L'),
    ('qDoaddr2', ''): ('qa', 'X', 'L')
...
multiplier.debug('111110111', step_limit=500)
'''
    COMMENTS
    ...
    x)  the addition of the xxxxxDxxxxD is my answer
